...
ECView :: ECView() : fQuit(false), keyLastPressed(KEY_NULL)
{
    status.Dump();
    Init();
}
...
void ECView :: AddRow(const std::string &strRow)
{
...
void ECView :: AppendRowBuffer(int row, const string &strRow)
{
...
void ECView :: AppendStatusMsg(int rs)
{
    bufferWnd += "\x1b[0K";
...
void ECView :: SetColor(int row, int colBegin, int colEnd, TEXT_COLOR clr)
{
