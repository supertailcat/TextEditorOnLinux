...
//***********************************************************
// Key code. Use this to match the keycode you get from ECView
...
// This is the internal status of ECView. You don't need to use this in your code.
...
//
// ECView provides basci functionalities for a text view
...
//
//  Please note: ECView only provides very basic error handling
//  Also note: you are responsible for what text to show on the screen and where to place cursor
//  ECView has no concerns about formatting at all. You need to figure out how many
//  rows you are going to show on the screen
//
// Note: ECView implements *** Observer *** pattern
...
class ECView : public ECObserverSubject
{
public:
    ECView();
    virtual ~ECView();
    ...
    // You don't have to specify all rows; ECView aautomatically fills the remaining rows
    ...
    // Be careful: ECView doesn't check whether the coordinates you specified
...
private:
    ...
    // Must call Init before using ECView
    void Init();
    void ClearBuffer();
